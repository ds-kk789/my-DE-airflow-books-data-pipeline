...
# 3. store in postgres table (Load)
# operators: PythonOperator and PostgresOperator
# hooks: allow connection to postgres
        ...
        if response.status_code == 200:
            ...
            for book in book_containers:
                ...
                if title and author and price and rating:
                    ...
                    # Break the loop if we already have the required number of books
...
#operators: PythonOperator and PostgreesOperator
#hooks - allow connection to Postgres
